      ...
      <div class="col-md-12">
        <div class="alert alert-warning">
          ...
          <div class="alert alert-info">
              After you click submit button you are officially choose Education Video Public Poster. If you would like to start over, you may <a href="#" onclick="$('#reset').submit(); return false;" id="submit">Click here to reset</a>.
          </div>
          </form>
        <div class="card">
