    ...
    {{-- <div class="container"> --}}
      <div class="col-md-12">
          ...
          <div class="alert alert-danger">
            ...
            <ul>
              ...
              @elseif(count($errors)>1)
                <li>Uploaded proof of payment file cannot exceed 1 mb.</li>
                <li>Uploaded proof of payment file has to be jpeg, jpg or png format.</li>
                <li>Uploaded participant files cannot exceed 5 mb and has to be a zip format.</li>
              @else
                <li>Uploaded participant files cannot exceed 5 mb and has to be a zip format.</li>
              @endif
        ...
        <div class="alert alert-warning">
          ...
          <p>Hello <strong>{{Auth::user()->name}}</strong>. You have been assigned unique <strong>ID {{Auth::user()->id + 000}}</strong>. The amount you must transfer to register Educational Video is <strong>Rp {{ number_format($lomba->dp + Auth::user()->id + 000 ,2,',','.')}}</strong> (down payment). This is to make sure the verification process is done fast.</p>
          <hr>
          <p>Educational Video wave: {{$lomba->gelombang_sekarang}}</p>
        </div>
