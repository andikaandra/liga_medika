  ...
  <div class="row">
    {{-- <div class="container"> --}}
      <div class="col-md-12">
        ...
        <form id="dataPeserta" method="post" enctype="multipart/form-data" action="{{route('register.imarc.traditional.dance')}}">
        @csrf
        <div id="contentPanel">
