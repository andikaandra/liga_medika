	...
	<section class="banner-area-inamsc-social-programme relative" id="home">
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				...
				<p class="text-white link-nav mb-5"><a href="{{url('/')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{url('inamsc-social-programme')}}"> INAMSC Social Programme</a></p>
				<p class="text-white about text-justify" style="font-size: 16px">
