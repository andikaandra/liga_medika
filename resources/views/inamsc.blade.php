...
<section class="banner-area-inamsc relative" id="home">	
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				...
				<p style="color: white">Semifinalist and Finalist Guideline INAMSC 2019, and INAMSC 2019 Logo</p><a href="{{url('inamsc/finalist-guidelines?v=1.2')}}" class="btn btn-warning">Download Here</a>
				<br>
