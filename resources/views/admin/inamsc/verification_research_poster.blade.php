...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    let dataTable = $(".table").DataTable({
      responsive: true,
      ajax: '{{url('admin/inamsc/research-poster')}}',
      columns: [
        {data: "id"},
        {data: "user.name"},
        {data: "user.email"},
    ...
    $(document).on('click', '.info', async function(){
      ...
      try {
          data = await $.ajax({
            url: '{{url('admin/inamsc/research-poster')}}/' + id
          });
      } catch (e) {
        alert("Ajax error");
        console.log(e);
    ...
    $(document).on('click', '.accept', function(){
      ...
      async function(){
        ...
        try {
          await $.ajax({
            url: '{{url('admin/inamsc/research-poster/accept')}}/' + id,
            method: "PUT"
          });
        } catch (e) {
          alert("ajaax error");
    ...
    $(document).on('click', '.decline', function(){
      ...
      async function(){
        ...
        try {
          await $.ajax({
            url: '{{url('admin/inamsc/research-poster/decline')}}/' + id,
            method: "PUT"
          });
        } catch (e) {
          alert("ajaax error");
