...
@section('content')
	<!-- start banner Area -->
	<section class="banner-area-hfgm relative" id="home">	
		...
		<div class="container">
	        ...
	        <div class="row my-5 wow slideInLeft">
	            <div class="col-lg-5 quote-left">
					<img class="img-fluid" src="{{asset('img/ligmed/campaign.JPG')}}" alt="campaign" style="width: 100%;">
	            </div>
	        ...
	        <div class="row my-5 wow slideInRight">
	            <div class="col-lg-7 quote-left">
	                <h1 class="text-info mb-3" style="font-weight: bold; font-size: 36px">Opening Liga Medika</h1>
	                <p class="justify text-justify">
						Opening Liga Medika 2019 akan dilaksanakan bersamaan dengan Gala Dinner yang dibawakan oleh Social Program Liga Medika. Acara ini bertujuan untuk meresmikan dimulainya Liga Medika 2019 dan menyambut seluruh peserta kontingen Liga Medika 2019.
	                </p>
	            </div>
	            <div class="col-lg-5 quote-right">
					<img class="img-fluid" src="{{asset('img/ligmed/opening.JPG')}}" alt="vocal group" style="width: 100%;">
	            </div>
			</div>
			<hr>
			<div class="row my-5 wow slideInLeft">
			...
			<div class="col-lg-7 quote-right">
				<h1 class="text-info mb-3" style="font-weight: bold; font-size: 36px">Closing Liga Medika</h1>
				<p class="justify text-justify">
					Closing Ceremony Liga Medika merupakan acara dengan konsep art performance dimana akan mengundang beberapa performer untuk meramaikan panggung Closing Liga Medika. Pada acara Closing Liga Medika 2019, akan ditampilkan Juara 1 Lomba Band dari IMARC serta diumumkan para pemenang kompetisi Liga Medika 2019 sekaligus seremonial penutup dari keseluruhan acara Liga Medika 2019.
				</p>
			</div>			
		</div>
	        <div class="row my-5 wow slideInUp justify-content-center slow">
				<a href="{{url('register')}}" class="hfgm-btn">Register NOW</a>
	        </div>
		</div>
	</section>
@endsection
